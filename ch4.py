...
app.config['SECRET_KEY'] = 'AjwkVgUw6jQ8fjzGcji9ygAVJSrfWMhD'  #p38

## p38

class NameForm(FlaskForm):
    name = StringField("What is your name?", validators=[DataRequired()])
    age = IntegerField("What is your age?", validators=[DataRequired(), NumberRange(12)])
    rating = RadioField("Select your rating", validators=[DataRequired()], choices=[(1, '*'),(2,'**'),(3, '***'), (4,'****'), (5, '*****')])

    submit = SubmitField("Submit")

@app.route('/form_demo')
def form_demo():
    return render_template("form_demo.html", form=NameForm())
